 ...
 */
@interface EkoOIDTokenResponse : NSObject <NSCopying, NSSecureCoding>

/*! @brief The request which was serviced.
 */
@property(nonatomic, readonly) EkoOIDTokenRequest *request;
...
/*! @brief The approximate expiration date & time of the access token.
    @remarks expires_in
    @seealso EkoOIDTokenResponse.accessToken
    @see https://tools.ietf.org/html/rfc6749#section-4.1.4
    @see https://tools.ietf.org/html/rfc6749#section-5.1
 */
...
/*! @brief ID Token value associated with the authenticated session. Always present for the
    ...
    @see https://jwt.io
    @discussion @c EkoOIDIDToken can be used to parse the ID Token and extract the claims. As noted,
