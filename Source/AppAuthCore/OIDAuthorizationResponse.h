/*! @file EkoOIDAuthorizationResponse.h
 ...
 */
@interface EkoOIDAuthorizationResponse : NSObject <NSCopying, NSSecureCoding>

/*! @brief The request which was serviced.
 */
@property(nonatomic, readonly) EkoOIDAuthorizationRequest *request;
...
/*! @brief The approximate expiration date & time of the access token.
    @discussion Set when the response_type requested includes 'token'.
    @remarks expires_in
    @seealso EkoOIDAuthorizationResponse.accessToken
    @see http://openid.net/specs/openid-connect-core-1_0.html#ImplicitAuthResponse
 */
...
/*! @brief Creates a token request suitable for exchanging an authorization code for an access
        token.
    @return A @c EkoOIDTokenRequest suitable for exchanging an authorization code for an access
        token.
    @see https://tools.ietf.org/html/rfc6749#section-4.1.3
 */
- (nullable EkoOIDTokenRequest *)tokenExchangeRequest;
...
/*! @brief Creates a token request suitable for exchanging an authorization code for an access
    ...
    @see https://tools.ietf.org/html/rfc6749#section-4.1.3
 */
- (nullable EkoOIDTokenRequest *)tokenExchangeRequestWithAdditionalParameters:
